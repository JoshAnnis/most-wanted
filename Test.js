describe('getPerson', function () {
  ...
  it('Jasmine Bob', function () {
   ...
   expect(getPerson('Jasmine', 'Bob',people)).toEqual(person);
  });
});
...
expect(getKids('Joy',people)).toEqual([]);
